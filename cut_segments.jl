...
aff_start=[max(data_start[i], data_start[i]+offset[i]-1) for i in 1:3]
aff_end=[min(data_end[i], data_start[i]+offset[i]+chunk_size[i]-1) for i in 1:3]
seg_start=[max(data_start[i], data_start[i]+offset[i]-1-margin[i]) for i in 1:3]
seg_end=[min(data_end[i], data_start[i]+offset[i]+chunk_size[i]-1+margin[i]) for i in 1:3]
